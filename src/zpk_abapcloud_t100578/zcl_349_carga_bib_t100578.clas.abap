class zcl_349_carga_bib_t100578 definition
  public
  final
  create public .
...
class zcl_349_carga_bib_t100578 implementation.

  method if_oo_adt_classrun~main.

    "NEW CHANGE1

    data: lt_acc_categ type table of z349_accateg_578,
          lt_catego    type table of z349_catego_578,
          lt_clientes  type table of z349_cliente_578,
          lt_clnts_lib type table of z349_clntlib_578,
          lt_libros    type table of z349_libro_578.
...
******** TABLA1 ********
    ...
    delete from z349_accateg_578.
    insert z349_accateg_578 from table @lt_acc_categ.
...
******** z349_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from z349_catego_578.
    insert z349_catego_578 from table @lt_catego.
...
******** z349_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from z349_cliente_578.
    insert z349_cliente_578 from table @lt_clientes.
...
******* z349_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from z349_clntlib_578.
    insert z349_clntlib_578 from table @lt_clnts_lib.
...
******* z349_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from z349_libro_578.
    insert z349_libro_578 from table @lt_libros.
